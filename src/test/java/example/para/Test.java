...
import com.ruizhi.concurrenttool.StandaloneAsync;
...
//    testScene3();
  ...
  private static void testScene1() {
    ...
    StandaloneAsync.start(30000,wrapper1, wrapper2, wrapper3,wrapper4);
  ...
  private static void testScene2() {
    ...
    StandaloneAsync.start(30000,wrapper1, wrapper2, wrapper3,wrapper4,wrapper5);
    logger.info(StandaloneAsync.getDefaultTheadPoolTaskInfo());
  ...
  /**
   * 4个任务节点测试,节点三有两个任务并行执行，3_1和3_2都完成后进行任务4
   *           3_1/
   * 1 -> 2 ->     -> 4
   *           3_2/
   */
  private static void testScene3() {
    Task1 task1 = new Task1();
    Task2 task2 = new Task2();
    Task3 task3_1 = new Task3(1000);
    Task3 task3_2 = new Task3(2000);
    Task4 task4 = new Task4();
    ...
    TaskWrapper<String, String> wrapper3_1 = new TaskWrapper.Builder<String, String>()
            .task(task3_1)
            .id("t3_1")
            .param("p3_1")
            .callback(task3_1)
            .pre(wrapper2)
            .build();
    TaskWrapper<String, String> wrapper3_2 = new TaskWrapper.Builder<String, String>()
            .task(task3_2)
            .id("t3_2")
            .param("p3_2")
            .callback(task3_2)
    ...
    StandaloneAsync.start(30000,wrapper1, wrapper2, wrapper3_1,wrapper3_2,wrapper4);
    logger.info(StandaloneAsync.getDefaultTheadPoolTaskInfo());
  ...
  /**
   * 4个任务节点测试,节点三有两个任务并行执行，3_1完成后执行4，3_2是否执行完成不影响4的执行
   *           3_1/
   * 1 -> 2 ->     -> 4
   *           3_2
   */
   ...
   * 2 ->   |
   */
  private static void testScene3_1() {
    Task1 task1 = new Task1();
    Task2 task2 = new Task2();
    Task3 task3 = new Task3();
    Task4 task4 = new Task4();
   ...
   * 4 -> |
   */
  private static void testScene4_1() {
