...
public class Task7 implements ITask<String, String>, ITaskCallback<String, String> {
    private static final Logger logger = LoggerFactory.getLogger(Task7.class);

    private static final String TASK_NAME = "task7";
